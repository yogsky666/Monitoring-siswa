            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6 class="text-blue-700 text-xl font-bold">Tambah Data Siswa</h6>
                    </div>

                    <!-- Form -->
                    <form action="{{ route('siswa.store') }}" method="POST" class="flex-auto p-6 space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="nisn" id="nisn"
                                class="focus:shadow-primary-outline text-sm focus:border-blue-500 block w-full rounded-lg border border-gray-300 bg-white p-3 leading-5 text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:ring"
                                placeholder="Masukkan NISN" required value="{{ old('nisn') }}">
                            @error('nisn')
                        ...
                        <!-- Kelas -->
                        <div>
                            <label for="id_kelas" class="block mb-2 text-sm font-medium text-gray-700">Kelas</label>
